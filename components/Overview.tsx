  ...
  return (
    <div className="space-y-12 pb-10">
      ...
      <section className="grid grid-cols-2 gap-5">
        <div className="bg-[#E64A4A] p-7 rounded-[3rem] text-white comic-border comic-shadow">
          <div className="flex items-center gap-2 mb-3 opacity-90 font-bold">
            <TrendingUp size={20} />
        ...
        <div className="bg-white p-7 rounded-[3rem] comic-border comic-shadow text-black">
          <div className="flex items-center gap-2 mb-3 text-slate-500 font-bold">
            <ShoppingBag size={20} className="text-[#1FA67A]" />
          ...
          <p className="text-[13px] font-bold text-slate-500 mt-2 uppercase">含分擔與個人</p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="space-y-6">
          {recentTransactions.map(t => (
            <div key={t.id} className="bg-white comic-border p-7 rounded-[2.5rem] flex flex-col gap-6 comic-shadow transition-all relative group">
